...
export async function OfficesGrid({ section }: { section: PageSectionRow }) {
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {offices.map((office, i) => (
          <Reveal key={office.id} delay={i * 80}>
            <div className="group h-full rounded-2xl border border-black/5 bg-white p-8 shadow-sm transition-all duration-300 ease-out hover:-translate-y-1.5 hover:shadow-xl">
